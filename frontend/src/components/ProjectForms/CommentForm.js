...
class CommentForm extends Component{
    ...
    render(){
        ...
        return (     
            <Grid container xs={12} direction='column' alignItems="center" justify="center" style={{minHeight:'70vh'}}>
            <Grid item xs={10}>
            ...
            <Grid container justify="center" style={{marginTop:'2vh', padding:20, height: "100%"}}
            >
                <Grid item xs={12}>
                    <TextField
                ...
                <Grid container justify='space-between' xs={12} md={12} style={{padding:20}}>
                                    <Grid item>
