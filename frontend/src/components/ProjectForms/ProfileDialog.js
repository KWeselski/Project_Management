    ...
    return (
            <StyledDialog open={openDialog}> 
                ...
                <Grid container justify="space-between">
                    <Typography style={{padding: 10}} variant='h5'>{values.firstname +' '+ values.lastname}</Typography>
                    <Button type="submit" onClick={() => {setOpenDialog(false)}}>X</Button>
                </Grid>        
                </DialogTitle>
                <StyledDialogContent dividers>
                    <Grid container xs={12}>
                        ...
                        <Grid container xs={12} style={{marginTop:10, height:200}}>
                                ...
                                <Grid item xs={12}>
                                    <Typography variant='h6'><b>Phone:</b> {values.phone}</Typography>
                                </Grid>
                                <Grid item xs={12}>
                                    <Typography variant='h6'><b>About me:</b> {values.description}</Typography>
                                </Grid>
